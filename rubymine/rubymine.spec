...
Source1: https://download-cf.jetbrains.com/ruby/RubyMine-%{version}.tar.gz
Source2: rubymine.rpmlintrc
Source3: https://download-cf.jetbrains.com/ruby/RubyMine-%{version}-aarch64.tar.gz
